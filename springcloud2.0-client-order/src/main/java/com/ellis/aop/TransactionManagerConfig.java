...
public class TransactionManagerConfig {
	...
	//定义切点变量：拦截com.ellis.order.service包下所有类的所有方法,返回值类型任意的方法
	private static final String AOP_POINTCUT_EXPRESSION="execution (* com.ellis.order.service..*(..))";
	@Autowired
